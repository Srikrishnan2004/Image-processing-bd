...
# Create the Django class-based view without REST framework
class ImageProcessingView(View):
    def post(self, request, *args, **kwargs):
        ...
        # Process the image using Ying_2017_CAIP
        result_img = Ying_2017_CAIP(img_array)

        # Convert the result to an image and save it in-memory
